...
import com.bsrakdg.movies.ui.movie.MainActivity
...
class GalleryActivityTest {
    ...
    @Test
    fun test_validateGalleryIntent() { // pickFromGallery
        ...
        intending(expectedIntent).respondWith(activityResult) // like when thenReturn

        // EXECUTE AND VERIFY
        onView(withId(R.id.button_open_gallery)).perform(click())
        intended(expectedIntent) // check did happen??
    }
